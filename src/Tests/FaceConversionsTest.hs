module Tests.FaceConversionsTest(faceConversionsTestDo) where
import Test.HUnit
import CornerPoints.CornerPoints(CornerPoints(..), (+++))
import CornerPoints.Points(Point(..))
import CornerPoints.FaceConversions(getBackFaceFromRightFaceFromCube, invertFace)
import CornerPoints.FaceExtraction(extractFrontFace)

faceConversionsTestDo = do
  ...
  let getBackFaceFromRightFaceFromCubeTest = TestCase $ assertEqual
       ...
       (getBackFaceFromRightFaceFromCube(CubePoints (Point 1 1 1) (Point 2 2 2) (Point 3 3 3) (Point 4 4 4) (Point 11 11 11) (Point 12 12 12) (Point 13 13 13) (Point 14 14 14)))
  ...
  let addPerpendicularCubesTest = TestCase $ assertEqual
       ...
       (let smallCube = (CubePoints (Point 101 101 101) (Point 102 102 102) (Point 103 103 103) (Point 104 104 104) (Point 201 2011 201) (Point 202 202 202) (Point 203 203 203) (Point 204 204 204))
            ...
            largeRightFaceAsBackFace = getBackFaceFromRightFaceFromCube largeCube
